...
public class ProstorTest
{
    ...
    public  void testLzeProjit() {		
        Prostor prostor1 = new Prostor("hala", "vstupní hala budovy VŠE na Jižním městě", 1, 1);
        Prostor prostor2 = new Prostor("bufet", "bufet, kam si můžete zajít na svačinku", 1, 2);
